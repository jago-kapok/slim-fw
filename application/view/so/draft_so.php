<div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
          ...
          <ul class="breadcrumb">
          <li>
              <a href="<?php echo Config::get('URL') . 'so/createSo/';?>">
                <span class="badge badge-success">
                <i class="glyphicon glyphicon-plus"></i> Buat Draft SO
                </span>
              </a>
          </li>
          </ul><!-- /.breadcrumb -->
        ...
        <div class="table-responsive">
            ...
            foreach($this->transaction_group as $key => $value) {
                ...
                if ($row > 1) {
                    for ($i=1; $i <= $row; $i++) {
                        ...
                        if ($i === 1) {
                            ...
                            echo '<td class="text-right" rowspan="' . $row . '">
                              ...
                              <a href="#" onclick="approveSo(\'' . $value->transaction_number . '\', \'' . 'row-' . $no . '\');"><span class="badge badge-info"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Approve</span></a>
                            </td>';
                            echo "</tr>";
                        } else {
                            echo '<tr class="' . 'row-' . $no . ' ' . $feedbackStatus . '">';
                    ...
                    echo '<td><a href="' .  Config::get('URL') . 'so/detail/?so_number=' . urlencode($value->transaction_number) . '">' . $value->transaction_number . '</a><br>'. $feedbackNote.'</td>';
