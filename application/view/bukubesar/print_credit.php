  ...
  <thead>
          ...
          <tbody>
            <tr class="border">
              ...
              <td class="text-right"><?php echo $this->transaction[0]->credit;?></td>
          </tr>
          <tr class="border">
              <td colspan="2" class="text-right"><strong>Total: </strong></td>
              <td class="text-right"><?php echo number_format($this->transaction[0]->credit);?></td>
          </tr>
          <tr class="border">
              <td colspan="3"><strong>Terbilang:</strong> <?php echo ucwords(FormaterModel::terbilangRupiah($this->transaction[0]->credit)); ?></td>
          </tr>
    </tbody>
    </table>
  <br>
