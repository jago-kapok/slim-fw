...
function resetPage(url) {
    window.location.replace("<?php echo Config::get('URL'); ?>production/detail/?production_number=" + url);
}
...
function insertMaterial() {
  ...
  table += '<td contenteditable="true" class="saved-materials"></td>';
...
function finishAndSave() {
  ...
  var production_number = document.getElementById("production-number").textContent;
  ...
  var url = "<?php echo Config::get('URL'); ?>production/saveInsertManualMaterialConsumption/";
  var params = "&material_list=" + material_string.join(' ') + "&production_number=" + production_number;
...
<body>
  ...
  <div class="container" id="kasir-box-1">
    <table class="ExcelTable2007">
      <thead>
        <tr>
          <th id="production-number" colspan="7"><?php echo $this->job_number; ?></th>
        </tr>
        <tr>
          <th class="">#</th>
          <th class="">Code</th>
  ...
  <div class="container" id="kasir-box-2"></div>
  <div class="container" id="kasir-box-3"></div>
