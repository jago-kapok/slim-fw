...
function finishAndSave() {
  ...
  var so_number = document.getElementById("so_number").innerHTML;
  ...
  var url = "<?php echo Config::get('URL'); ?>production/saveForcastJobOrder/";
  var params = "material_list=" + material_string.join(' ') + "&so_number=" + so_number + "&job_type=" + job_type + "&job_note=" + job_note;
  ...
  <div class="container" id="kasir-box-1">
    <table  id="table-pembayaran" class="ExcelTable2007">
      ...
      <tbody>
        <tr>
          <td colspan="4">
            <textarea id="job-note" placeholder="Keterangan Pekerjaan" style="min-height: 100px;"></textarea>
          </td>
        </tr>
      </tbody>
    </table>
