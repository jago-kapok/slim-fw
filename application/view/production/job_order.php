...
function finishAndSave() {
  ...
  var url = "<?php echo Config::get('URL'); ?>production/saveJobOrder/";
  var params = "product_list=" + product_string.join(' ') + "&material_list=" + material_string.join(' ') + "&job_type=" + job_type + "&job_note=" + job_note + "&note=" + note;
    ...
    <table  id="table-pembayaran" class="ExcelTable2007">
      <thead>
        <tr>
          ...
          <th>
            <input type="text" autocomplete="off" id="job-note" autocomplete="off"/>
          </th>
          <th style="max-width: 21px;">
            Keterangan:
          </th>
