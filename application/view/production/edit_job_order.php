  ...
  <div class="container" id="kasir-box-1">
    <table  id="table-pembayaran" class="ExcelTable2007">
      <thead>
        <tr>
          <th>SO Reverence:</th>
          <th id="so-number"><?php echo $this->production_forcasting[0]->production_reverence; ?></th>
          <th>JO Number</th>
          <th id="production-number"><?php echo urldecode(Request::get('production_number')); ?></th>
          <th>Tipe Order:</th>
          <th>
            <select id="job-type">
      ...
      <tbody>
        <tr>
          <td colspan="6">
            <textarea id="job-note" placeholder="Keterangan Pekerjaan" style="min-height: 100px;"><?php echo $this->production_forcasting[0]->note; ?></textarea>
          </td>
        </tr>
      </tbody>
    </table>
