            ...
            <div class="navbar-buttons navbar-header pull-right" role="navigation">
                <ul class="nav ace-nav">
                    <?php
                                ...
                                switch ($username) {
                                    case 'nur':
                                        $notification = NotificationModel::directorNur();
                                        break;
                                    case 'eko':
                                        $notification = NotificationModel::directorEko();
                                        break;
                                    case 'root':
                                        $notification = NotificationModel::director();
                                        break;
                                    
                                    default:
                                        //$notification = null;
                                        $notification = NotificationModel::directorSupanto();
                                        break;
                                }
                                
                                $total_notif = $notification->total_so_request_approval + $notification->total_po_request_approval + $notification->total_edit_po_request_approval + $notification->total_nota_pembelian_request_approval + $notification->total_sj_request_approval + $notification->total_payment_disbursement;

                                
                                //percentage for design
                                $percentage_so = (int)(($notification->total_so_request_approval/$total_notif) * 100);

                                $percentage_purchase = (int)((($notification->total_po_request_approval + $notification->total_edit_po_request_approval + $notification->total_nota_pembelian_request_approval)/$total_notif) * 100);

                                $percentage_sj = (int)(($notification->total_sj_request_approval/$total_notif) * 100);

                                $percentage_payment = (int)(($notification->total_payment_disbursement/$total_notif) * 100);
                    
                    //echo or not notification
                    if ($total_notif > 0 ) {
                    ?>
                    ...
                    <li class="grey">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <i class="ace-icon fa fa-bell icon-animated-bell"></i>
                                <span class="badge badge-grey"><?php echo $total_notif; ?></span>
                        ...
                        <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                            ...
                            <li class="dropdown-content">
                                <ul class="dropdown-menu dropdown-navbar">
                                    ...
                                    <?php if (!empty($notification->total_so_request_approval)) { ?>
                                    <li>
                                        <a href="<?php echo Config::get('URL') . 'so/waitingApproval'; ?>">
                                            <div class="clearfix">
                                                <span class="pull-left">Sales Approval</span>
                                                <span class="pull-right"><?php echo $notification->total_so_request_approval;?></span>
                                            </div>

                                            <div class="progress progress-mini">
                                                <div style="width:<?php echo $percentage_so;?>%" class="progress-bar"></div>
                                            </div>
                                        </a>
                                    </li>
                                    <?php } ?>

                                    <?php if (!empty($notification->total_po_request_approval) OR !empty($notification->total_edit_po_request_approval) OR !empty($notification->total_nota_pembelian_request_approval)) { ?>
                                    <li>
                                        <a href="<?php echo Config::get('URL') . 'po/waitingApproval'; ?>">
                                            <div class="clearfix">
                                                <span class="pull-left">Purchase Approval</span>
                                                <span class="pull-right"><?php echo ($notification->total_po_request_approval + $notification->total_edit_po_request_approval + $notification->total_nota_pembelian_request_approval); ?></span>
                                            </div>

                                            <div class="progress progress-mini">
                                                <div style="width:<?php echo $percentage_po;?>%" class="progress-bar progress-bar-danger"></div>
                                            </div>
                                        </a>
                                    </li>
                                    <?php } ?>

                                    <?php if (!empty($notification->total_sj_request_approval)) { ?>
                                    <li>
                                        <a href="<?php echo Config::get('URL') . 'so/waitingSjApproval/'; ?>">
                                            <div class="clearfix">
                                                <span class="pull-left">SJ Approval</span>
                                                <span class="pull-right"><?php echo $notification->total_sj_request_approval?></span>
                                            </div>

                                            <div class="progress progress-mini">
                                                <div style="width:<?php echo $percentage_sj;?>%" class="progress-bar progress-bar-warning"></div>
                                            </div>
                                        </a>
                                    </li>
                                    <?php } ?>

                                    <?php if (!empty($notification->total_payment_disbursement)) { ?>
                                    <li>
                    ...
                    <div class="main-container ace-save-state" id="main-container">
                        ...
                        <div id="sidebar" class="sidebar responsive ace-save-state">
                            ...
                            <ul class="nav nav-list">
                                <li <?php if (isset($this->activelink1)) { if ($this->activelink1 == 'dashboard') {echo ' class="active open" ';}} ?> >
                                    ...
                                    <ul class="submenu">
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'dashboard penjualan') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>dashboard/sales">
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'dashboard pembelian') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>dashboard/purchase/">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                pembelian
                                            </a>
                                ...
                                <li <?php if (isset($this->activelink1)) { if ($this->activelink1 == 'Employee') {echo ' class="active open" ';}} ?> >
                                    <a href="#" class="dropdown-toggle">
                                    ...
                                    <ul class="submenu">
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'daftar pegawai') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>Employee/">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Daftar Pegawai
                                            </a>
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'seting gaji') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>systemPreference/salary/">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Seting Gaji
                                            </a>
                                ...
                                <li <?php if (isset($this->activelink1)) { if ($this->activelink1 == 'penjualan') {echo ' class="active open" ';}} ?> >
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'order book') {echo ' class="active open" ';}} ?> >
                                            <a href="#" class="dropdown-toggle">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                            ...
                                            <ul class="submenu">
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'new order book') {echo ' class="active" ';}} ?> >
                                                    <a href="<?php echo Config::get('URL') . 'orderBook/order'; ?>">
                                                        <i class="menu-icon glyphicon glyphicon-shopping-cart green"></i>
                                                        Buat Transaksi
                                                    </a>
                                                    <b class="arrow"></b>
                                                ...
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'order book report') {echo ' class="active" ';}} ?> >
                                                    <a href="<?php echo Config::get('URL') . 'orderBook/report/'; ?>">
                                                        <i class="menu-icon fa fa-bar-chart-o green"></i>
                                                        Laporan
                                                    </a>
                                                    <b class="arrow"></b>
                                                </li>
                                ...
                                <li <?php if (isset($this->activelink1)) { if ($this->activelink1 == 'Manufacturing') {echo ' class="active open" ';}} ?> >
                                    <a href="#" class="dropdown-toggle">
                                    ...
                                    <ul class="submenu">
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'Production') {echo ' class="active open" ';}} ?> >
                                            <a href="#" class="dropdown-toggle">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                            ...
                                            <ul class="submenu">
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'Production On Process') {echo ' class="active" ';}} ?> >
                                                    <a href="<?php echo Config::get('URL') . 'production/onProcess/'; ?>">
                                                ...
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'Production Finished') {echo ' class="active" ';}} ?> >
                                                    <a href="<?php echo Config::get('URL') . 'production/finished/'; ?>">
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'Production') {echo ' class="active open" ';}} ?> >
                                            ...
                                            <ul class="submenu">
                                                <li>
                                                    <a href="<?php echo Config::get('URL') . 'jobOrder/createJobOrder/'; ?>">
                                                ...
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'Internal Job On Process') {echo ' class="active" ';}} ?> >
                                                    <a href="<?php echo Config::get('URL') . 'jobOrder/onProcess/'; ?>">
                                                        <i class="menu-icon fa fa-fire"></i>
                                                        On Process
                                                    </a>
                                                ...
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'Internal Job Finished') {echo ' class="active" ';}} ?> >
                                                    <a href="<?php echo Config::get('URL') . 'jobOrder/finished/'; ?>">
                                                        <i class="menu-icon glyphicon glyphicon-check"></i>
                                                        Finished
                                                    </a>
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'waiting approval') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL') . 'JobOrder/madeTimeReport/'; ?>">
                                                <i class="menu-icon glyphicon glyphicon-check"></i>
                                                Laporan Lama Produksi
                                            </a>
                                ...
                                <li <?php if (isset($this->activelink1)) { if ($this->activelink1 == 'qc') {echo ' class="active open" ';}} ?> >
                                    <a href="#" class="dropdown-toggle">
                                        <i class="menu-icon glyphicon glyphicon-check"></i>
                                    ...
                                    <ul class="submenu">
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'Unconformity') {echo ' class="active open" ';}} ?> >
                                            <a href="#" class="dropdown-toggle">
                                            ...
                                            <ul class="submenu">
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'Unconformity Raw Material') {echo ' class="active" ';}} ?> >
                                                    <a href="<?php echo Config::get('URL') . 'qc/unconformityRawMaterial/'; ?>">
                                                ...
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'Unconformity Production') {echo ' class="active" ';}} ?> >
                                                    <a href="<?php echo Config::get('URL') . 'qc/unconformityProduction/'; ?>">
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'waiting approval') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL') . 'qc/waitingApproval/'; ?>">
                                                <i class="menu-icon glyphicon glyphicon-check"></i>
                                                Waiting Approval
                                            </a>
                                ...
                                <li <?php if (isset($this->activelink1)) { if ($this->activelink1 == 'inventory') {echo ' class="active open" ';}} ?> >
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'log keluar masuk barang') {echo ' class="active open" ';}} ?> >
                                            ...
                                            <ul class="submenu">
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'log barang masuk') {echo ' class="active open" ';}} ?> >
                                                    <a href="#" class="dropdown-toggle">
                                                    ...
                                                    <ul class="submenu">
                                                        <li <?php if (isset($this->activelink4)) { if ($this->activelink4 == 'log barang masuk bahan baku') {echo ' class="active" ';}} ?> >
                                                            <a href="<?php echo Config::get('URL'); ?>inventory/logInRawMat">
                                                                <i class="menu-icon glyphicon glyphicon-leaf purple"></i>
                                                                Raw Mat
                                                            </a>
                                                        ...
                                                        <li <?php if (isset($this->activelink4)) { if ($this->activelink4 == 'log barang masuk fgwh') {echo ' class="active" ';}} ?> >
                                                            <a href="<?php echo Config::get('URL'); ?>inventory/logInFinishGood">
                                                                <i class="menu-icon fa fa-gift green"></i>
                                                                FGWH
                                                            </a>
                                                        ...
                                                        <li <?php if (isset($this->activelink4)) { if ($this->activelink4 == 'log barang masuk all') {echo ' class="active" ';}} ?> >
                                                            <a href="<?php echo Config::get('URL'); ?>inventory/logInAll">
                                                                <i class="menu-icon glyphicon glyphicon-th"></i>
                                                                All
                                                            </a>
                                                ...
                                                <li <?php if (isset($this->activelink3)) { if ($this->activelink3 == 'log barang keluar') {echo ' class="active open" ';}} ?> >
                                                    <a href="#" class="dropdown-toggle">
                                                    ...
                                                    <ul class="submenu">
                                                        <li <?php if (isset($this->activelink4)) { if ($this->activelink4 == 'log barang keluar bahan baku') {echo ' class="active" ';}} ?> >
                                                            <a href="<?php echo Config::get('URL'); ?>inventory/logOutRawMat">
                                                                <i class="menu-icon glyphicon glyphicon-leaf purple"></i>
                                                                Raw Mat
                                                            </a>
                                                        ...
                                                        <li <?php if (isset($this->activelink4)) { if ($this->activelink4 == 'log barang keluar fgwh') {echo ' class="active" ';}} ?> >
                                                            <a href="<?php echo Config::get('URL'); ?>inventory/logOutFinishGood">
                                                                <i class="menu-icon fa fa-gift green"></i>
                                                                FGWH
                                                            </a>
                                                        ...
                                                        <li <?php if (isset($this->activelink4)) { if ($this->activelink4 == 'log barang keluar all') {echo ' class="active" ';}} ?> >
                                                            <a href="<?php echo Config::get('URL'); ?>inventory/logOutAll">
                                                                <i class="menu-icon glyphicon glyphicon-th"></i>
                                                                All
                                                            </a>
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'out of safety stock') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL') . 'inventory/updateStockBulk'; ?>">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Update Stock (Bulk)
                                            </a>
                                ...
                                <li <?php if (isset($this->activelink1)) { if ($this->activelink1 == 'System Preference') {echo ' class="active open" ';}} ?> >
                                    ...
                                    <ul class="submenu">
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'company profile') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>systemPreference/companyProfile/">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Company Profile
                                            </a>
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'material category') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>systemPreference/materialCategory/">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Kategori Material
                                            </a>
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'company profile') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>systemPreference/purchaseApproval/">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Approval Pembelian
                                            </a>
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'System Preference workingHours') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>systemPreference/workingHours/">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Jam Kerja/Shift
                                            </a>
                                        ...
                                        <li>
                                            <a href="<?php echo Config::get('URL'); ?>Backup/">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Backup Database
                                            </a>
                                        ...
                                        <li <?php if (isset($this->activelink2)) { if ($this->activelink2 == 'About') {echo ' class="active" ';}} ?> >
                                            <a href="<?php echo Config::get('URL'); ?>systemPreference/about/">
