                    ...
                    <li class="grey">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="badge badge-grey">
                                ...
                                echo $total_notif = $notification->total_so_request_approval + $notification->total_po_request_approval + $notification->total_edit_po_request_approval + $notification->total_sj_request_approval + $notification->total_payment_disbursement;

                                if ($total_notif > 0 ) {
                                    //percentage for design
                                    $percentage_so = (int)(($notification->total_so_request_approval/$total_notif) * 100);
                                    $percentage_po = (int)(($notification->total_po_request_approval/$total_notif) * 100);
                                    $percentage_edit_po = (int)(($notification->total_edit_po_request_approval/$total_notif) * 100);
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li>
                                        <a href="<?php echo Config::get('URL') . 'so/waitingApproval'; ?>">
                                            <div class="clearfix">
                                                <span class="pull-left">SO Approval</span>
