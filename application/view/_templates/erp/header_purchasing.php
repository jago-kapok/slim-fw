                ...
                <ul class="nav ace-nav">
                    <li class="grey">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <?php
                                    $notification = NotificationModel::purchasing();
                                    $total_notif = $notification->total_new_pr;

                                    if ($total_notif > 0 ) {
                                        //percentage for design
                                        $percentage_new_pr = (int)(($notification->total_new_pr/$total_notif) * 100);
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li>
                                        <a href="<?php echo Config::get('URL') . 'pr/pr'; ?>">
                                            <div class="clearfix">
                                                <span class="pull-left">New PR</span>
                                                <span class="pull-right"><?php echo $notification->total_new_pr?></span>
                                            </div>

                                            <div class="progress progress-mini">
                                                <div style="width:<?php echo $percentage_new_pr;?>%" class="progress-bar"></div>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
