                ...
                <ul class="nav ace-nav">
                    <li class="grey">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <?php
                                $notification = NotificationModel::qualityControl();
                                $total_notif = $notification->total_waiting_qc_approval;

                                if ($total_notif > 0 ) {
                                    //percentage for design
                                    $percentage_waiting_qc_approval = (int)(($notification->total_waiting_qc_approval/$total_notif) * 100);
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li>
                                        <a href="<?php echo Config::get('URL') . 'pr/pr'; ?>">
                                            <div class="clearfix">
                                                <span class="pull-left">Waiting Approval</span>
                                                <span class="pull-right"><?php echo $notification->total_waiting_qc_approval?></span>
                                            </div>

                                            <div class="progress progress-mini">
                                                <div style="width:<?php echo $percentage_waiting_qc_approval;?>%" class="progress-bar"></div>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
