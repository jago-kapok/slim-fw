          ...
          if ($row > 1) {
              for ($i=1; $i <= $row; $i++) {
                  ...
                  if ($i === 1) {
                      ...
                      echo '<td  rowspan="' . $row . '"><a href="' .  Config::get('URL') . 'po/detail/?po_number=' . urlencode($value->transaction_number) . '">' . $value->transaction_number . '</a></td>';
                      
                      echo '<td rowspan="' . $row . '">' . $value->supplier_id . '</td>';
