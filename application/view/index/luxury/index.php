...
<link rel="stylesheet" type="text/css" href="<?php echo Config::get('URL'); ?>theme/luxury/styles/bootstrap4/bootstrap.min.css">
<link href="<?php echo Config::get('URL'); ?>theme/luxury/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="<?php echo Config::get('URL'); ?>theme/luxury/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="<?php echo Config::get('URL'); ?>theme/luxury/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="<?php echo Config::get('URL'); ?>theme/luxury/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="<?php echo Config::get('URL'); ?>theme/luxury/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="<?php echo Config::get('URL'); ?>theme/luxury/styles/responsive.css">
</head>
<body>
...
<div class="super_container">
            ...
            <div class="row">
                <div class="col">
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        <div class="logo">
                            <a href="#"><img src="/theme/luxury/images/logo.png" alt=""></a>
                        </div>
                        <nav class="main_nav">
                            <ul>
                        ...
                        <div class="phone_num ml-auto">
                            <div class="phone_num_inner">
                                <img src="images/phone.png" alt=""><span>081-336-400-555</span>
                            </div>
                        </div>
    ...
    <div class="menu trans_500">
        ...
        <div class="menu_phone"><span>call us: </span>081336400555</div>
    </div>
    ...
    <div class="home">
        ...
        <div class="home_slider_container">
            <div class="owl-carousel owl-theme home_slider">
                ...
                <!-- Slide -->
                <div class="owl-item">
                    <div class="home_slider_background" style="background-image:url(/theme/luxury/images/home-slider-the-stature-jakarta.jpg)"></div>
                    <div class="slide_container">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="slide_content">
                                        <div class="home_subtitle">Menteng. Jakarta</div>
                                        <div class="home_title">Apartemen Super Mewah</div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="slide_content">
                                        ...
                                        <div class="home_price">Rp 8.2 Miliar</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="search_form_content d-flex flex-row align-items-start justfy-content-start flex-wrap">
                                    <div>
                                        <select class="search_form_select">
                                            <option disabled selected>Jual/Sewa</option>
                                            <option>Jual</option>
                                            <option>Sewa</option>
                                        </select>
                                    </div>
                                    <div>
                                        <select class="search_form_select">
                                            <option disabled selected>Jenis Properti</option>
                                            <option>Rumah</option>
                                            <option>Ruko</option>
                                    ...
                                    <div>
                                        <select class="search_form_select">
                                            ...
                                            <option>Malang Kota</option>
                                            <option>Malang Kabupaten</option>
                                            <option>Surabaya</option>
                                            <option>Jakarta</option>
                                        </select>
                                    </div>
                                    <div style="width: 40%">
                                        <input class="form-control form-control-lg" type="text" placeholder="Kata Kunci" style="margin-top: 12px;width: 100%">
                                    </div>
                                </div>
    ...
    <footer class="footer">
        <div class="footer_main">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="footer_logo align-items-center"><a href="#"><img src="images/logo.png" alt="" class="text-center"></a></div>
                    </div>
...
<script src="<?php echo Config::get('URL'); ?>theme/luxury/js/jquery-3.2.1.min.js"></script>
<script src="<?php echo Config::get('URL'); ?>theme/luxury/styles/bootstrap4/popper.js"></script>
<script src="<?php echo Config::get('URL'); ?>theme/luxury/styles/bootstrap4/bootstrap.min.js"></script>
<script src="<?php echo Config::get('URL'); ?>theme/luxury/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="<?php echo Config::get('URL'); ?>theme/luxury/plugins/easing/easing.js"></script>
<script src="<?php echo Config::get('URL'); ?>theme/luxury/plugins/parallax-js-master/parallax.min.js"></script>
<script src="<?php echo Config::get('URL'); ?>theme/luxury/js/custom.js"></script>
</body>
</html>