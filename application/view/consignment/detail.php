          ...
          <ul class="breadcrumb" >
            <li>
              <div class="btn-group btn-corner">
                  <a href="<?php echo  Config::get('URL') . 'consignment/laporan'; ?>" class="btn btn-minier btn-default"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> list</a>
                  <?php if (Auth::isPermissioned('director')) { ?>
                  <a href="<?php echo  Config::get('URL') . 'consignment/deleteSales/?transaction_number=' . urlencode($this->so->transaction_number) . '&forward=kasir/laporan/'; ?> " onclick="return confirmation('Are you sure to delete?');" class="btn btn-minier btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> delete</a>
                  <?php } //if (Auth::isPermissioned('director')) { ?>
              </div>
            </li>
            ...
            <li>
              <div class="btn-group btn-corner">
                  ...
                  <a href="<?php echo Config::get('URL') . 'consignment/printOut/?transaction_number=' . urlencode($this->so->transaction_number);?>" class="btn btn-minier btn-info">
