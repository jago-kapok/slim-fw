    ...
    <div class="main-content-inner">
      ...
      <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search">
            <form class="form-search" method="get" action="<?php echo Config::get('URL') . 'consignment/index/';?>">
      ...
      <div class="collapse" id="changeDateRange">
        <div class="well">
          <form method="post" action="<?php echo Config::get('URL') . 'consignment/reportByDate/'; ?>">
              ...
              if ($row > 1) {
                  for ($i=1; $i <= $row; $i++) {
                      ...
                      if ($i === 1) {
                          ...
                          echo '<td  rowspan="' . $row . '"><a href="' .  Config::get('URL') . 'consignment/detail/?transaction_number=' . urlencode($value->transaction_number) . '">' . $value->transaction_number . '</a></td>';
                          echo '<td  rowspan="' . $row . '" class="text-center">' . $value->contact_name . '</td>';
                          ...
                          echo '<td rowspan="' . $row . '"><a href="#" onclick=printPage("' . Config::get('URL') . 'consignment/printKasir/?transaction_number=' . urlencode($value->transaction_number) . '")>
                          ...
                          if (Auth::isPermissioned('director')) {
                            echo '<td rowspan="' . $row . '">
                            <a href="' . Config::get('URL') . 'consignment/deleteSales/?transaction_number=' . urlencode($value->transaction_number) . '&forward=consignment/laporan/" onclick="return confirmation(\'Are you sure to delete?\');">
                  ...
                  echo '<td><a href="' .  Config::get('URL') . 'consignment/detail/?transaction_number=' . urlencode($value->transaction_number) . '">' . $value->transaction_number . '</a></td>';
                  ...
                  echo '<td><a href="#" onclick=printPage("' . Config::get('URL') . 'consignment/printKasir/?transaction_number=' . urlencode($value->transaction_number) . '")>
                    <span class="badge badge-inverse">
                    <span class="glyphicon glyphicon-print" aria-hidden="true"></span>
                    </span>
                  </a></td>';
