...
function finishAndSave() {
  ...
  var forcasting_number = document.getElementById("forcasting_number").textContent;
  ...
  var url = "<?php echo Config::get('URL'); ?>productionForcasting/saveEditForcasting/";
  var params = encodeURIComponent("material_list=" + material_string.join(' ') + "&forcasting_number=" + forcasting_number + "&job_type=" + job_type);
    ...
    <table  id="table-pembayaran" class="ExcelTable2007">
      <thead>
        <tr>
          ...
          <th id="forcasting_number"><?php echo urldecode(Request::get('transaction_number')); ?></th>
          <th>Tipe Order:</th>
          <th>
            <select id="job-type">
