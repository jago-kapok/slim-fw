...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT uid, full_name, user_name, email, address_street, address_city, address_state, address_stayed, phone, is_active, user_has_avatar, is_deleted FROM users";
        ...
        foreach ($query->fetchAll() as $user) {
            ...
            $all_users_profiles[$user->uid]->full_name = $user->full_name;
    ...
    public static function getPublicProfileOfUser($uid)
    {
        ...
        $sql = "SELECT uid, full_name, user_name, email, address_street, address_city, address_state, previous_address, phone, is_active, user_has_avatar, is_deleted
    ...
    public static function getUserIdByUsername($user_name)
    {
        ...
        $sql = "SELECT uid FROM users WHERE user_name = :user_name LIMIT 1";
        $query = $database->prepare($sql);
    ...
    public static function getUserDataByUserIdAndToken($uid, $token)
    {
        ...
        $query = $database->prepare("SELECT uid, user_name, email, user_password_hash, is_active,
                                     ...
                                     WHERE uid = :uid
                                       ...
                                       AND user_remember_me_token IS NOT NULL LIMIT 1");
        $query->execute(array(':uid' => $uid, ':user_remember_me_token' => $token));
