...
class LoginModel
{
    ...
    public static function login($user_name, $user_password, $set_remember_me_cookie = null)
    {
        ...
        self::setSuccessfulLoginIntoSession(
            $result->uid, $result->user_name, $result->full_name, $result->email, $result->user_account_type, $result->department, $result->grade
        );
    ...
    public static function loginWithCookie($cookie)
    {
        ...
        if ($result) {
            ...
            // successfully logged in, so we write all necessary data into the session and set "user_logged_in" to true
            self::setSuccessfulLoginIntoSession($result->uid, $result->user_name, $result->full_name, $result->email, $result->user_account_type, $result->department, $result->grade);
     ...
     */
    public static function setSuccessfulLoginIntoSession($uid, $user_name, $full_name, $email, $user_account_type, $department, $grade)
    {
        Session::init();
