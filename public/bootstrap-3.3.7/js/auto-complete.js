            ...
            for (var a = "object" == typeof l.selector ? [l.selector] : document.querySelectorAll(l.selector), u = 0; u < a.length; u++) {
                ...
                i.sc = document.createElement("div"), i.sc.className = "autocomplete-suggestions " + l.menuClass, i.autocompleteAttr = i.getAttribute("autocomplete"), i.setAttribute("autocomplete", "off"), i.cache = {}, i.last_val = "", i.updateSC = function(e, t) {
                    ...
                    if (t(this, "autocomplete-suggestion")) {
                        ...
                        i.innerHTML = o, l.onSelect(e, o, this), i.sc.style.display = "none"
                    }
                    ...
                    e ? i !== document.activeElement && setTimeout(function() {
                        i.focus()
                    }, 20) : (i.last_val = i.innerHTML, i.sc.style.display = "none", setTimeout(function() {
                ...
                i.keydownHandler = function(e) {
                    ...
                    if ((40 == t || 38 == t) && i.sc.innerHTML) {
                        ...
                        return s ? (o = 40 == t ? s.nextSibling : s.previousSibling, o ? (s.className = s.className.replace("selected", ""), o.className += " selected", i.innerHTML = o.getAttribute("data-val")) : (s.className = s.className.replace("selected", ""), i.innerHTML = i.last_val, o = 0)) : (o = 40 == t ? i.sc.querySelector(".autocomplete-suggestion") : i.sc.childNodes[i.sc.childNodes.length - 1], o.className += " selected", i.innerHTML = o.getAttribute("data-val")), i.updateSC(0, o), !1
                    }
                    if (27 == t) i.innerHTML = i.last_val, i.sc.style.display = "none";
                    else if (13 == t || 9 == t) {
